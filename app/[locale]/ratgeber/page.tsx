    ...
    <main className="min-h-screen bg-[#f4f2ed] text-[#171717]">
      <section className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
        ...
        <header className="border-b border-[#d8d3c9] pb-6">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#2f6a57]">{content.eyebrow}</p>
          <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">{content.title}</h1>
